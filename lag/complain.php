  	...
  	<?php
		...
		?>
 			<div style="clear: both"></div>
  			...
  			<div id="complainbody">
			  <div id="upbottondash" style="background-color:#04477e"><a href="#.php">View Complaint</a></div>
			  <div id="upbottondash"><a href="createcomplaint.php">Create Complaint</a></div>
			  <div id="upbottondash"><a href="deletecomplaint.php">Delete Complaint</a></div>
			  <div style="clear: both"></div>
			  <div id="complainbodymain">
			    <table width="100%" border="1">
			      <tbody>
                    ...
                    <th width="53%" scope="col">Description</th>
